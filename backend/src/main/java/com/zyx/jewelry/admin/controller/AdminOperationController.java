...
public class AdminOperationController {
    ...
    public ApiResponse<List<Map<String, Object>>> listProducts() {
        return ApiResponse.success(adminOperationService.listProducts());
    }
    ...
    public ApiResponse<Map<String, Object>> createProduct(@Valid @RequestBody CreateProductRequest request) {
        return ApiResponse.success(adminOperationService.createProduct(new ProductService.AdminCreateProductCommand(
            request.categoryId(),
            request.name(),
            request.subtitle(),
            request.productNo(),
